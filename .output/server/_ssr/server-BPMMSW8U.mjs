...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-qvQAEOEK.mjs");
...
const manifest = {
  "55cbb0ccceeac9040323e7bc33abb4620b0e86351462f98a7b8c26bb9a2beeec": {
    functionName: "getAvailableSlots_createServerFn_handler",
    importer: () => import("./index-BEhM5nb_.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CJ551Cx9.mjs").then((n) => n.r),
    import("./start-DCN7KFKQ.mjs"),
