...
export const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    slug: 'prayas-app',
    index: '03',
    title: 'Prayas App & Admin Portal',
    name: 'Prayas App & Admin Portal',
    category: 'Mobile App · Website · Admin Portal',
    client: 'Prayas NGO',
    date: 'Tuesday, June 18, 2024',
    duration: '5 – 6 Weeks',
    location: 'Mathura & Agra, India',
    summary: 'Healthcare Logistics Ecosystem — Mobile App, Public Website & Admin Portal',
    subtitle: 'Decentralized Medical Inventory Control, Blood Donation Network & Multi-Channel Admin Console',
    challenge:
      'Prayas NGO required a comprehensive multi-platform ecosystem — combining a volunteer/donor mobile app, a public website, and a centralized admin management portal to coordinate emergency blood donations, health equipment lending, and community outreach at scale.',
    solution:
      'Engineered an integrated healthcare logistics suite consisting of a high-performance React Native mobile app for donors and patients, a responsive public website for community engagement, and a secure web admin portal for real-time equipment inventory tracking, blood request dispatch, and volunteer coordination.',
    features: [
      'Mobile app for donor-recipient matching & blood drives',
      'Centralized web admin portal for inventory & request dispatch',
      'Public community website for donor registration & transparency',
      'Real-time medical equipment lending & lifecycle tracking',
    ],
    outcome:
      'Standardized outreach across mobile and web platforms, enabling Prayas NGO to serve over 10,000+ community members with unified real-time health logistics and streamlined administration.',
    stack: ['React Native', 'React.js', 'Next.js', 'Node.js', 'PostgreSQL', 'Firebase'],
    techStack: ['React Native', 'React.js', 'Next.js', 'Node.js', 'PostgreSQL', 'Firebase'],
    year: '2024',
  ...
  },
  {
    ...
    index: '06',
    title: 'Lead Enrichment Platform',
    name: 'Lead Enrichment Platform',
