        ...
        <div className="w-full xl:absolute xl:left-[calc(min(476px,30vw)+72px)] xl:right-[40px] xl:top-[540px] z-10">
          ...
          <div className="hidden xl:grid grid-cols-5 gap-3 w-full">
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-1 row-start-1 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2 p-4 h-[120px] 2xl:h-[130px] select-none"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-3 row-start-1 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2 p-4 h-[120px] 2xl:h-[130px] select-none"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-5 row-start-1 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2 p-4 h-[120px] 2xl:h-[130px] select-none"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-2 row-start-2 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2 p-4 h-[120px] 2xl:h-[130px] select-none"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-4 row-start-2 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2 p-4 h-[120px] 2xl:h-[130px] select-none"
            >
