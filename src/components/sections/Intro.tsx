        ...
        <div className="w-full max-w-[500px] xl:max-w-none xl:absolute xl:left-[530px] xl:top-[550px] z-10">
          ...
          >
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-1 row-start-1 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2.5 p-4 select-none"
            >
              <svg width="32" height="32" viewBox="0 0 109 113" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                <path d="M63.7076 110.284C60.848 113.885 55.0502 111.912 54.9836 107.314L53.9738 37.0689L99.4437 37.0689C106.214 37.0689 110.027 44.8252 105.787 50.1652L63.7076 110.284Z" fill="#3ECF8E" />
                <path d="M45.317 2.50702C48.1766 -1.09423 53.9744 0.878775 54.041 5.47718L54.3484 75.7225L9.58094 75.7225C2.81036 75.7225 -1.00244 67.9662 3.23724 62.6262L45.317 2.50702Z" fill="#3ECF8E" />
              </svg>
              <span className="text-[17px] font-semibold text-fg">Supabase</span>
            </a>
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-3 row-start-1 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2.5 p-4 select-none"
            >
              <svg width="28" height="26" viewBox="0 0 116 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-fg shrink-0">
                <path fillRule="evenodd" clipRule="evenodd" d="M57.5 0L115 100H0L57.5 0Z" />
              </svg>
              <span className="text-[17px] font-semibold text-fg">Vercel</span>
            </a>
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-5 row-start-1 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2.5 p-4 select-none"
            >
              <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-fg shrink-0">
                <path d="M22.282 9.821a5.985 5.985 0 0 0-.516-4.91 6.046 6.046 0 0 0-6.51-2.9A6.065 6.065 0 0 0 4.981 4.18a5.985 5.985 0 0 0-3.998 2.9 6.046 6.046 0 0 0 .743 7.097 5.98 5.98 0 0 0 .51 4.911 6.051 6.051 0 0 0 6.515 2.9A5.985 5.985 0 0 0 13.26 24a6.056 6.056 0 0 0 5.772-4.206 5.99 5.99 0 0 0 3.997-2.9 6.056 6.056 0 0 0-.747-7.073zM13.26 22.43a4.476 4.476 0 0 1-2.876-1.04l.141-.081 4.779-2.758a.795.795 0 0 0 .392-.681v-6.737l2.02 1.168a.071.071 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494zM3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085 4.783 2.759a.771.771 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.033.062L9.74 19.95a4.5 4.5 0 0 1-6.14-1.646zM2.34 7.896a4.485 4.485 0 0 1 2.366-1.973V11.6a.766.766 0 0 0 .388.676l5.815 3.355-2.02 1.168a.076.076 0 0 1-.071 0l-4.83-2.786A4.504 4.504 0 0 1 2.34 7.872zm16.597 3.855l-5.833-3.387L15.119 7.2a.076.076 0 0 1 .071 0l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.407-.667zm2.01-3.023-.141-.085-4.774-2.782a.776.776 0 0 0-.785 0L9.409 9.23V6.897a.066.066 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zm-12.64 4.135l2.6-1.5 2.6 1.5v3l-2.6 1.5-2.6-1.5z" />
              </svg>
              <span className="text-[17px] font-semibold text-fg">OpenAI</span>
            </a>
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-2 row-start-2 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2.5 p-4 select-none"
            >
              <svg width="34" height="34" viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-[#087ea4] shrink-0">
                <circle cx="0" cy="0" r="2.05" fill="#087ea4"/>
                <g stroke="#087ea4" strokeWidth="1" fill="none">
                  <ellipse rx="11" ry="4.2"/>
                  <ellipse rx="11" ry="4.2" transform="rotate(60)"/>
              ...
              <span className="text-[17px] font-semibold text-fg">React 19</span>
            </a>
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="col-start-4 row-start-2 bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2.5 p-4 select-none"
            >
              ...
              <span className="text-[17px] font-semibold text-fg">Flutter</span>
            </a>
          </div>
