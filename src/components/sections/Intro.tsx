...
export default function Intro() {
  ...
  return (
    <>
      ...
      <section className="relative w-full h-auto xl:h-[1050px] bg-bg select-none px-[20px] md:px-[28px] xl:px-[40px] py-8 xl:py-0 flex flex-col xl:block gap-8 xl:gap-0">
        {/* Video Card — Positioned directly below GLD 1 eyebrow with inner scroll parallax */}
        <div
          ref={videoWrapperRef}
          className="w-full max-w-[500px] h-[500px] md:h-[640px] mx-auto xl:mx-0 xl:w-[min(440px,28vw)] xl:h-[760px] xl:absolute xl:left-[40px] xl:top-[48px] rounded-[12px] overflow-hidden z-20 bg-surface border border-line-solid shadow-2xl relative shrink-0"
          data-cursor="view"
        >
          <div
            ref={videoInnerRef}
        ...
        {/* Word Rail positioned at top: 380px on desktop, or normal flow in mobile/tablet */}
        <div className="xl:absolute xl:top-[380px] xl:left-0 w-full z-[5] pointer-events-none my-4 xl:my-0">
          <WordRail
        ...
        <div className="w-full xl:w-auto xl:absolute xl:left-[calc(min(440px,28vw)+48px)] xl:right-[40px] xl:top-[480px] z-10">
          ...
          {/* Desktop 5-Card Solid Row (>=1200px) */}
          <div className="hidden xl:grid grid-cols-5 gap-3 w-full">
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-cursor="link"
              className="bg-surface border border-line-solid hover:bg-surface-2 transition-colors duration-200 rounded-[12px] flex flex-col items-center justify-center gap-2 p-3.5 h-[118px] 2xl:h-[128px] select-none"
            >
              ...
              <div className="text-center">
                <span className="text-[14.5px] 2xl:text-[16px] font-semibold text-fg block leading-tight">Supabase</span>
                <span className="text-[11px] text-fg-muted font-normal block mt-0.5">Backend & DB</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-center">
                <span className="text-[14.5px] 2xl:text-[16px] font-semibold text-fg block leading-tight">React 19</span>
                <span className="text-[11px] text-fg-muted font-normal block mt-0.5">Modern UI</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-center">
                <span className="text-[14.5px] 2xl:text-[16px] font-semibold text-fg block leading-tight">Vercel</span>
                <span className="text-[11px] text-fg-muted font-normal block mt-0.5">Edge Cloud</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-center">
                <span className="text-[14.5px] 2xl:text-[16px] font-semibold text-fg block leading-tight">Flutter</span>
                <span className="text-[11px] text-fg-muted font-normal block mt-0.5">Mobile Apps</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-center">
                <span className="text-[14.5px] 2xl:text-[16px] font-semibold text-fg block leading-tight">OpenAI</span>
                <span className="text-[11px] text-fg-muted font-normal block mt-0.5">AI Agents</span>
              </div>
            </a>
          </div>
          ...
          <div className="mt-6 xl:mt-8 w-full">
            ...
            <div className="hidden xl:grid grid-cols-3 gap-3 w-full">
              {/* Col 1: Prayas NGO */}
              <div
                className="bg-surface border border-line-solid rounded-[12px] flex items-center gap-3.5 p-3.5 h-[80px] select-none cursor-default"
              >
                <img src="/clients/prayas.jpg" alt="Prayas NGO" className="w-[46px] h-[46px] rounded-full object-cover shadow-sm border border-line-solid shrink-0" />
                <div>
                  <span className="text-[14.5px] font-semibold text-fg block leading-tight">Prayas NGO</span>
                  <span className="text-[11.5px] text-accent font-medium mt-0.5 block">10,000+ Reach</span>
                </div>
              </div>
              ...
              <div
                className="bg-surface border border-line-solid rounded-[12px] flex items-center gap-3.5 p-3.5 h-[80px] select-none cursor-default"
              >
                <img src="/clients/gla-canteen.png" alt="GLA Canteen" className="w-[46px] h-[46px] rounded-full object-contain p-1 bg-white shadow-sm border border-line-solid shrink-0" />
                <div>
                  <span className="text-[14.5px] font-semibold text-fg block leading-tight">GLA Canteen</span>
                  <span className="text-[11.5px] text-accent font-medium mt-0.5 block">Zero Discrepancies</span>
                </div>
              </div>
              ...
              <div
                className="bg-surface border border-line-solid rounded-[12px] flex items-center gap-3.5 p-3.5 h-[80px] select-none cursor-default"
              >
                <img src="/clients/earth-travels.png" alt="Earth Travels India" className="w-[46px] h-[46px] rounded-full object-contain p-1 bg-white shadow-sm border border-line-solid shrink-0" />
                <div>
                  <span className="text-[14.5px] font-semibold text-fg block leading-tight">Earth Travels</span>
                  <span className="text-[11.5px] text-accent font-medium mt-0.5 block">Real-time Booking</span>
                </div>
              </div>
            </div>
          </div>
