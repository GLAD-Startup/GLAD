...
export function Row({
  ...
  const content = (
    <div
      className={cn(
        "group relative grid grid-cols-[64px_1fr_auto] max-[720px]:grid-cols-[40px_1fr] items-center gap-6 py-6 px-2 border-b border-[var(--color-rule)] last:border-b-0 group-last/row:border-b-0 rounded-[var(--radius-md,8px)]",
