          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between pointer-events-none">
                <span
                  className={`text-[10px] font-black tracking-widest ${isActive ? "opacity-90" : "text-muted-foreground/60"}`}
                >
                  0{i + 1} // PRACTICE
                </span>
                <span
                ...
                >
                  <Icon
                    ...
                    style={{ color: isActive ? "currentColor" : colors[i] }}
                  />
                </span>
              </div>
              ...
              <div className="pointer-events-none mt-2">
                <h3 className="font-display font-black text-xs leading-none tracking-wide">
                  {labels[i]}
                </h3>
                <p
                  className={`text-[9px] mt-1.5 leading-snug font-semibold ${isActive ? "opacity-85" : "text-muted-foreground/70"}`}
                >
                  {descriptions[i]}
                </p>
              </div>
